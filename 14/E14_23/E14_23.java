/*
  Write a program that prompts the user to enter the center coordinates, width,
  and height of two rectangles from the command line. The program displays the
  rectangles and a text indicating whether the two are overlapping, whether one
  is contained in the other, or whether they don't overlap.
*/
...
public class E14_23 extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    Rectangle r1 = getRectangle(args.get(0), args.get(1), args.get(2),
      args.get(3));
    Rectangle r2 = getRectangle(args.get(4), args.get(5), args.get(6),
      args.get(7));
  ...
  private static Rectangle getRectangle(double centerX, double centerY,
  ...
  public static void main(String[] args) {
    if (args.length != 8) {
      System.out.println("Usage: java E14_23 centerX1 centerY1 width1 " +
