...
public class E14_11 extends Application {
  ...
  class SmileyPane extends StackPane {
    SmileyPane(double radius) {
      ...
      Arc mouth =
        new Arc(radius, radius + radius / 2.7, radius / 2, radius / 5, 180, 180);
      ...
      // Eye Whites
      Ellipse leftEyeWhite = new Ellipse(radius - radius / 3,
        radius - radius / 3, radius / 5, radius / 8);
      leftEyeWhite.setFill(Color.WHITE);
      leftEyeWhite.setStroke(Color.BLACK);
      Ellipse rightEyeWhite = new Ellipse(radius + radius / 3,
        radius - radius / 3, radius / 5, radius / 8);
      rightEyeWhite.setFill(Color.WHITE);
      rightEyeWhite.setStroke(Color.BLACK);

      // Eye Pupils
      Circle leftEyePupil = new Circle(leftEyeWhite.getCenterX(),
        leftEyeWhite.getCenterY(), leftEyeWhite.getRadiusX() / 2);
      Circle rightEyePupil = new Circle(rightEyeWhite.getCenterX(),
        rightEyeWhite.getCenterY(), rightEyeWhite.getRadiusX() / 2);

      // Add shapes to container
      pane.getChildren().addAll(head, mouth, nose, leftEyeWhite, leftEyePupil,
        rightEyeWhite, rightEyePupil);
