/*
  Listing 2.7, ShowCurrentTime.java, displays the current time. Improve this
  example to display the current date and time. The calendar example in
  Listing 6.12, PrintCalendar.java, should give you some ideas on how to find
...
public class E6_24 {
  public static void main(String[] args) {
    ...
    String output = getDate(totalMilliseconds) + " " +
  ...
  private static long[] getYear(long days) {
    ...
    int yearCount = 1970;
    while (days >= 365) {
      if (isLeapYear(yearCount)) { days -= 366; }
      else { days -= 365; }
      yearCount++;
    }
